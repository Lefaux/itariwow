...
BugGrabberDB = {
	...
	["errors"] = {
		{
			["message"] = "Interface/AddOns/ATT-Classic/src/base.lua:133: Interface/AddOns/ATT-Classic/ATT-Classic.lua:5027: attempt to compare number with nil",
			["time"] = "2024/07/03 11:36:39",
			["locals"] = "(*temporary) = \"Interface/AddOns/ATT-Classic/ATT-Classic.lua:5027: attempt to compare number with nil\"\n",
