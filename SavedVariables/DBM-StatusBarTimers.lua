...
DBT_AllPersistentOptions = {
	["Default"] = {
		["DBM"] = {
			...
			["Skin"] = "",
			["StartColorDB"] = 1,
			["Font"] = "Interface/AddOns/Gargul/Assets/Fonts/PTSansNarrow.ttf",
			["EndColorDB"] = 1,
			["EndColorAEB"] = 0.247,
			["Height"] = 25,
			["HugeSort"] = "Sort",
			...
			["TextColorG"] = 1,
			["KeepBars"] = true,
			["HugeTimerX"] = 19.80898094177246,
			["HugeTimerY"] = -90.28579711914062,
			["HugeAlpha"] = 1,
			["ColorByType"] = true,
			["IconLeft"] = true,
